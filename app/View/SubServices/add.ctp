<body> 
    <div class="page-title">	
        ...
        <h3>Add <span class="semi-bold">New Sub Services</span></h3>	
    </div>
        ...
        <div class="col-md-12">
            <div class="grid simple ">
                <div class="grid-body no-border" id="popup-validation">
                    <?php echo $this->Form->create('Category', array("url" => array("controller" => "SubServices", "action" => "add"), 'type' => 'file')); ?>  
                    <table class="table  no-more-tables">
                        <tbody>
                            ...
                            <tr class="form-group">
                                <td class="control-label col-lg-4"><label>Category</label></td>
                                <td class="col-lg-8"> <?php echo $this->Form->input('parent_id', array("label" => FALSE, 'id' => "source",  'options' => array($parent_names), 'style' => 'width: 250px; margin-bottom:5px;')); ?> </td> 
