<div class="page-title">	
    ...
    <h3>All <span class="semi-bold">Job Categories</span></h3>	
</div>
    ...
    <div class="col-md-12">
        <div class="grid simple ">
            <div class="grid-body no-border">
                <div >
                    <a class="btn-lg pull-right btn btn-primary btn-lg"  href="<?php echo $this->Html->url(array('contoller' => 'categories', 'action' => 'add')); ?>" data-original-title="" title="" style="margin:5px;">ADD</a>
                </div>
                    ...
                    <thead>
                        <tr >
                            ...
                            <th  style="text-align: center; font-size:130%">Category</th>
                             <th  style="text-align: center; font-size:130%">Logo</th>
                            <th  style="text-align: center; font-size:130%">Job</th>
                    ...
                    <tbody>
                        <?php foreach ($Categories as $key => $Category) {
                            ...
                            <tr>
                                ...
                                <td style="font-size:130%;"><img width="80" height="80" alt="" src="<?php echo Configure::read('img_url') . $Category["Category"]["icon"] ?>"></td>
                                <td style="font-size:130%;"><?php echo $Category["Category"]["name_en"] ?></td>
                                <td class = "text-center">
                                    <a class="btn" href="<?php echo $this->Html->url(array("controller" => "Categories", "action" => "edit", $Category["Category"]["id"])); ?>"> 
