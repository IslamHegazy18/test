<body> 
    <div class="page-title">	
        ...
        <h3>Edit <span class="semi-bold">Job</span></h3>	
    </div>
        ...
        <div class="col-md-12">
            <div class="grid simple ">
                <div class="grid-body no-border" id="popup-validation">
                    <?php echo $this->Form->create('Category', array("url" => array("controller" => "categories", "action" => "edit", $category_id), 'type' => 'file')); ?>  
                    <table class="table  no-more-tables">
                        <tbody>
                            <tr class="form-group">
                                <td class="control-label col-lg-4"><label>Main Category</label></td>
                                <td class="col-lg-8" >
                                    <label><?php echo $Categories["MainCategory"]["name_en"] ?></label>
                                    <img width="80" height="80" alt="" src="<?php echo Configure::read('img_url') . $Categories["MainCategory"]["image"] ?>">
                                </td>
                            </tr>
                            <tr class="form-group">
                                <td class="control-label col-lg-4"><label>Job Logo</label></td>
                                <td class="col-lg-8" ><img width="80" height="80" alt="" src="<?php echo Configure::read('img_url') . $Categories["Category"]["icon"] ?>"><?php echo $this->Form->input('file', array("id" => "image", "label" => false, "class" => "form-control", "type" => "file")); ?></td>
                            </tr>
                            <tr class="form-group">
